...
<div class="tabs">
    ...
    <div id="rotation">    
          <div class="region region-content-rotation">
    <div id="block-views-3f97b1ff08fd6bb74042c78b4a0b5bc8" class="block block-views">

    
  <div class="content-content_rotation">
    <div class="view view-flexslider-unithomepage-rotation view-id-flexslider_unithomepage_rotation view-display-id-block view-dom-id-b84d8029557cd93595b4ce60b4cb31e0">
        
  
  
      <div class="view-content">
	  	  
	  <?php print render($page['custom_slides']); ?>
...
<div id="bottom" class="three-boxes">  
        ...
        <div id="box1">
			<div class="region region-bottom-box1">
				<div id="block-views-unit-homepage-content-block-2" class="block block-views">

			
					<div class="content-bottom_box1">
						<div class="view view-unit-homepage-content view-id-unit_homepage_content view-display-id-block_2 view-dom-id-995e8bf9650d052119fc537d30692a5f">
							...
							<div class="view-content">
								<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">     
									<div>
										<div>
											<h2>Quick Links</h2>			  
											<?php print render($page['quick_links_box']); ?>
										</div>
									</div>
								</div>
							</div>
        ...
        <div id="box2">
			<div class="region region-bottom-box2">
				<div id="block-views-unit-homepage-content-block-3" class="block block-views">

			
					<div class="content-bottom_box2">
						<div class="view view-unit-homepage-content view-id-unit_homepage_content view-display-id-block_3 view-dom-id-f8a62f7abb02f3ee2f2e2fe66fd52526">
							...
							<div class="view-content">
								<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">     
									<div>
										<div>
											<h2>Resources</h2>			  
											<?php print render($page['resources_box']); ?>
										</div>
									</div>
								</div>
							</div>
		...
		<div id="box3">
			<div class="region region-bottom-box3">
				<div id="block-views-unit-homepage-content-block-4" class="block block-views">

			
					<div class="content-bottom_box3">
						<div class="view view-unit-homepage-content view-id-unit_homepage_content view-display-id-block_4 view-dom-id-94011866113dfbab4be95a42e042b79d">
							...
							<div class="view-content">
								<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">     
									<div>
										<div>
											<h2>News</h2>			  
											<?php print render($page['news_box']); ?>
										</div>
									</div>
								</div>
							</div>
...
<?php else :?>	
						...
						<div class="menu-block-wrapper menu-block-1 menu-name-menu-human-resources parent-mlid-0 menu-level-1">
							<ul class="menu">
								<li class="first last expanded active-trail menu-mlid-7082">
									...
									<?php print render($page['right_menu']); ?>
								</li>
							</ul>
						</div>
					</div>
	...
	<?php endif; ?>
		...
		<div>
			<?php print render($page['university_totals_box']); ?>
		</div>
		<div>
			<?php print render($page['colleges_box']); ?>
		</div>
		<div>
			<?php print render($page['programs_box']); ?>
		</div>
